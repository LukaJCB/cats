...
class AlgebraInvariantSuite extends CatsSuite {
  ...
  checkAll("InvariantMonoidal[Semigroup]", SemigroupTests[Int](InvariantMonoidal[Semigroup].lift(0)).semigroup)
  checkAll("InvariantMonoidal[CommutativeSemigroup]", CommutativeSemigroupTests[Int](InvariantMonoidal[CommutativeSemigroup].lift(0)).commutativeSemigroup)

  checkAll("InvariantSemigroupal[Monoid]", SemigroupalTests[Monoid].semigroupal[Int, Int, Int])
